...
export function SortBy({ initialData }) {
   ...
   return (
      ...
      >
         ...
         <SelectContent>
            <SelectItem value="featured">Phổ Biến Nhất</SelectItem>
            <SelectItem value="most_expensive">Giá Cao Nhất</SelectItem>
            <SelectItem value="least_expensive">Giá Thấp Nhất</SelectItem>
         </SelectContent>
      </Select>
   )
}
   ...
   return (
      <Popover open={open} onOpenChange={setOpen}>
         <PopoverTrigger asChild>
            ...
            >
               {value ? getCategoryTitle() : 'Chọn danh mục...'}
      ...
      <Popover open={open} onOpenChange={setOpen}>
         <PopoverTrigger asChild>
            <Button
               ...
               className="w-full justify-between"
            >
               {value ? getBrandTitle() : 'Chọn thương hiệu...'}
               <ChevronsUpDown className="ml-2 h-4 shrink-0 opacity-50" />
            </Button>
         </PopoverTrigger>
         <PopoverContent className="w-full p-0">
      ...
      <div className="flex w-full border rounded-md items-center space-x-2">
         <div className="mx-auto flex gap-2 items-center">
            <Switch
               ...
               id="available"
            />
            <Label htmlFor="available">Chỉ Còn Hàng</Label>
         </div>
      </div>
   )
}
